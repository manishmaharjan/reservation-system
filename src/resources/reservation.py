...
class ReservationId(Resource):
    ...
    def get(self, apiKeyUser, userId, reservationId):
        ...
        if not reservation:
            return Response(
                "No reservation found with the provided reservationId.", status=404
            )
        if reservation.user_id != userId:
            return Response(
                "Reservation does not belong to the provided userId.", status=403
            )
    ...
    def put(self, apiKeyUser, userId, reservationId):
        ...
        Returns:
            ...
            responses:
              ...
              404:
                description:
                No reservation found with the provided reservationId
